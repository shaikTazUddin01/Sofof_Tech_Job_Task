  ...
  return (
    <footer className="relative z-50">
      ...
      <nav className="flex justify-center relative z-10">
        <ul className="flex justify-between py-2 md:py-[14px] rounded-full navArea w-[90%] md:w-[492px] bg-white px-3 md:px-6 mb-[44px]">
          <li className="relative z-10 flex flex-col justify-center items-center home-item">
            <HomeIcon />
            <span className="bg-[#65358A] h-1 w-1 rounded-full mt-1.5 absolute top-[28px] md:top-[31px]"></span>
